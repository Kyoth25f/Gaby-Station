...
public sealed partial class AntagSelectionSystem : GameRuleSystem<AntagSelectionComponent>
{
    ...
    [Dependency] private readonly PlayTimeTrackingManager _playTimeManager = default!; // Goobstation
    ...
    public Dictionary<ICommonSession, float> ToWeightsDict(IList<ICommonSession> pool)
    {
        ...
        foreach (var se in pool)
            weights[se] = (float) (_playTimeManager.GetOverallPlaytime(se) - _lastRolled.GetLastRolled(se.UserId)).TotalSeconds;
